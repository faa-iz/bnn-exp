...
_DATASETS_MAIN_PATH = '/home/faaizasm/Datasets'
_dataset_path = {
    ...
    'imagenet': {
        'train': os.path.join('', '/export/data/dataset/Imagenet/ILSVRC2012/train'),
        'val': os.path.join('', '/export/data/dataset/Imagenet/ILSVRC2012/val')
    }
}
